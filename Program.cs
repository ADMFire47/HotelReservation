...
while again.lower() == "y":
    ...
    while True:
        ...
        # stripe non-zero time values from datetime object
        now = datetime.now()
    ...
    print(f"Departure Date:   {departure_date:fate_format}}")
    print(f"Nightly rate:     {locale.currency(rate)} {rate_messagee}")
    print(f"Total nights:     {total nights}")
